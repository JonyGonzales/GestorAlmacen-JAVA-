...
public class AddEntradaActivity extends AppCompatActivity {
        ...
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
         ...
         btn_producto.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
              Intent intent = new Intent( AddEntradaActivity.this, ListaProductoActivity.class );
         ...
         btn_tipo.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               Intent intent = new Intent( AddEntradaActivity.this, ListaTipoActivity.class );
               intent.putExtra("id",  user.getText().toString());
               intent.putExtra("fecha", fecha.getText().toString());
               intent.putExtra("idproducto", idproducto.getText().toString());
               intent.putExtra("producto", producto.getText().toString());
    ...
    @Override
     public void onBackPressed() {
         Intent intent = new Intent(AddEntradaActivity.this, MainActivity.class );
         startActivity(intent);
     }
    ...
    private void SaveEntrada(final String sid, final String sidproducto, final String sfecha, final String scantidad, final String sidtipo) {
  		...
  		StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            tipo.setText("");
  					...
  					Toast.makeText(AddEntradaActivity.this, ""+response, Toast.LENGTH_LONG).show();
  				}
  			}, new Response.ErrorListener() {
  				@Override
  				public void onErrorResponse(VolleyError error) {
  					hideDialog();
  					Toast.makeText(AddEntradaActivity.this, "Error: " +error.getMessage(), Toast.LENGTH_LONG).show();
  				}
  			}) {
  				@Override
