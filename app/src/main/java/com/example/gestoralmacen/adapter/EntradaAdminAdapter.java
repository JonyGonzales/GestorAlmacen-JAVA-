 ...
 */
public class EntradaAdminAdapter extends RecyclerView.Adapter<EntradaAdminAdapter.MyViewHolder> implements Filterable {
    ...
    public EntradaAdminAdapter(Context context, List<Entrada> notesList) {
