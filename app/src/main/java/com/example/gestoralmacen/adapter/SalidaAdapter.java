 ...
 */
public class SalidaAdapter extends RecyclerView.Adapter<SalidaAdapter.MyViewHolder> implements Filterable {
    ...
    public SalidaAdapter(Context context, List<Salida> notesList) {
