...
public class EditarSalidaActivity extends AppCompatActivity {
  ...
  private void EditSalida(final String sidsalida, final String sidproducto, final String sfecha, final String scantidad, final String sidtipo ) {
    ...
    StringRequest strReq = new StringRequest(Request.Method.POST,
        ...
        public void onResponse(String response) {
          ...
          Toast.makeText(EditarSalidaActivity.this, ""+response, Toast.LENGTH_LONG).show();
        }
      }, new Response.ErrorListener() {
        @Override
        public void onErrorResponse(VolleyError error) {
          hideDialog();
          Toast.makeText(EditarSalidaActivity.this, "Error: " +error.getMessage(), Toast.LENGTH_LONG).show();
        }
      }) {
        @Override
  ...
  public void onBackPressed() {
   Intent intent = new Intent(EditarSalidaActivity.this, MainActivity.class);
