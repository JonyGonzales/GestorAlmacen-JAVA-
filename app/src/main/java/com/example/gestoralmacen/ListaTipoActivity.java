...
public class ListaTipoActivity extends AppCompatActivity {
    ...
    private List<Tipo> listAnimation = new ArrayList<>();
    ...
    private void CargarData(String sid, String sidproducto, String sproducto, String scantidad, String sfecha,String sidtipo ,String stipo, String sactivit) {
      String url = 	"https://concursogtd.online/api/ListaTipo.php";
      showDialog();
          ...
          public void onResponse(String response) {
              try {
                  ...
                  for(int i = 0; i<myJsonArray.length(); i++){
                      ...
                      ob.setTipo(myJsonArray.getJSONObject(i).getString("nombre"));
  ...
  private void setupRecyclerView(List<Tipo> listAnimation , String pid, String pidproducto, String pproducto, String pcantidad, String pfecha, String pidtipo, String ptipo, String  pactivit) {
      ListadoTipoAdapter myadapter = new ListadoTipoAdapter(this,listAnimation , pid, pidproducto ,pproducto, pcantidad, pfecha, pidtipo ,ptipo, pactivit);
