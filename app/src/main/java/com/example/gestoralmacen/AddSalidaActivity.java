...
public class AddSalidaActivity extends AppCompatActivity {
      ...
      btn_fecha = (ImageView) findViewById(R.id.btn_fecha);
		...
		btn_producto.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				Intent intent = new Intent( AddSalidaActivity.this, ListaProductoActivity.class );
		...
		btn_tipo.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent = new Intent( AddSalidaActivity.this, ListaTipoActivity.class );
                intent.putExtra("id",  user.getText().toString());
                intent.putExtra("fecha", fecha.getText().toString());
                intent.putExtra("idproducto", ""+idproducto.getText().toString());
                intent.putExtra("producto", producto.getText().toString());
  ...
  private void SaveSalida(final String sid, final String sidproducto, final String sfecha, final String scantidad, final String sidtipo ) {
		...
		StringRequest strReq = new StringRequest(Request.Method.POST,
				...
				public void onResponse(String response) {
                    ...
                    idtipo.setText("");
                    tipo.setText("");
					Toast.makeText(AddSalidaActivity.this, ""+response, Toast.LENGTH_LONG).show();
				}
			}, new Response.ErrorListener() {
				@Override
				public void onErrorResponse(VolleyError error) {
					hideDialog();
					Toast.makeText(AddSalidaActivity.this, "Error: " +error.getMessage(), Toast.LENGTH_LONG).show();
				}
			}) {
				@Override
  ...
  @Override
     public void onBackPressed() {
       Intent intent = new Intent(AddSalidaActivity.this, MainActivity.class );
       startActivity(intent);
     }
