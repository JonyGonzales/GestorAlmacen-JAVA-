...
public class EditarSalidaAdminActivity extends AppCompatActivity {

    String bid, bidproducto, bproducto, bfecha, bcantidad, btipo, bidtipo;
    private EditText idsalida ,user, fecha, idproducto, producto, cantidad, idtipo, tipo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idsalida = (EditText) findViewById(R.id.idsalida);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View view) {
            EditSalida(channel,idproducto.getText().toString(), fecha.getText().toString(), cantidad.getText().toString(), idtipo.getText().toString());
          }
        });
    }
        ...
        if (id == R.id.action_add) {
            ...
            dialogo1.setPositiveButton("Si", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogo1, int id) {
                    EliminarSalida(idsalida.getText().toString(), idproducto.getText().toString(), cantidad.getText().toString());
                }
            });
  ...
  private void EditSalida(final String sidsalida, final String sidproducto, final String sfecha, final String scantidad, final String sidtipo ) {
    String tag_string_req = "req_register";
    pDialog.setMessage("Editando Salida ...");
    showDialog();
    StringRequest strReq = new StringRequest(Request.Method.POST,
            "https://concursogtd.online/api/editarSalida.php", new Response.Listener<String>() {
        @Override
        public void onResponse(String response) {
          hideDialog();

          Toast.makeText(EditarSalidaAdminActivity.this, ""+response, Toast.LENGTH_LONG).show();
        }
      }, new Response.ErrorListener() {
        @Override
        public void onErrorResponse(VolleyError error) {
          hideDialog();
          Toast.makeText(EditarSalidaAdminActivity.this, "Error: " +error.getMessage(), Toast.LENGTH_LONG).show();
        }
      }) {
        @Override
        protected Map<String, String> getParams() {
            Map<String, String> params = new HashMap<String, String>();
            params.put("idsalida", sidsalida);
  ...
  private void EliminarSalida(final String sidsalida, final String sidproducto, final String scantidad ) {
    String tag_string_req = "req_register";
    pDialog.setMessage("Eliminando Salida ...");
    showDialog();
    StringRequest strReq = new StringRequest(Request.Method.POST,
            "https://concursogtd.online/api/eliminarSalida.php", new Response.Listener<String>() {
        @Override
        public void onResponse(String response) {
          hideDialog();
  ...
  public void onBackPressed() {
   Intent intent = new Intent(EditarSalidaAdminActivity.this, AdminMainActivity.class);
