...
public class EditarEntradaActivity extends AppCompatActivity {
    ...
    private void EditEntrada(final String sid, final String sidproducto, final String sfecha, final String scantidad, final String sidtipo) {
  		...
  		StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            tipo.setText("");
  					...
  					Toast.makeText(EditarEntradaActivity.this, ""+response, Toast.LENGTH_LONG).show();
  				}
  			}, new Response.ErrorListener() {
  				@Override
  				public void onErrorResponse(VolleyError error) {
  					hideDialog();
  					Toast.makeText(EditarEntradaActivity.this, "Error: " +error.getMessage(), Toast.LENGTH_LONG).show();
  				}
  			}) {
  				@Override
  ...
  @Override
   public void onBackPressed() {
     Intent intent = new Intent(EditarEntradaActivity.this, MainActivity.class );
