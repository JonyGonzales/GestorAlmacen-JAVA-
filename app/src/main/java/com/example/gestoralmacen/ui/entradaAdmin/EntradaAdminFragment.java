package com.example.gestoralmacen.ui.entradaAdmin;
...
import com.example.gestoralmacen.AddEntradaAdminActivity;
...
import com.example.gestoralmacen.adapter.EntradaAdminAdapter;
import com.example.gestoralmacen.model.Entrada;
import org.json.JSONArray;
import java.util.ArrayList;
import java.util.List;

public class EntradaAdminFragment extends Fragment {

    private ProgressDialog pDialog;
    private List<Entrada> listAnimation = new ArrayList<>();
  ...
  private void CargarData() {
        String url = "https://concursogtd.online/api/ListaEntradas.php";
        showDialog();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_add:
                  Intent intent = new Intent(getActivity(), AddEntradaAdminActivity.class );
                intent.putExtra("id","");
    ...
    private void setupRecyclerView(List<Entrada> listAnimation) {
        EntradaAdminAdapter myadapter = new EntradaAdminAdapter(getActivity(),listAnimation) ;
