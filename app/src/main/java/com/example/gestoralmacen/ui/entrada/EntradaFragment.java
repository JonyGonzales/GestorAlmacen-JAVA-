package com.example.gestoralmacen.ui.entrada;
...
import com.example.gestoralmacen.adapter.EntradaAdapter;
...
public class EntradaFragment extends Fragment {
  ...
  private void CargarData() {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_add:
                Intent intent = new Intent(getActivity(), AddEntradaActivity.class );
                intent.putExtra("id","");
    ...
    private void setupRecyclerView(List<Entrada> listAnimation) {
        EntradaAdapter myadapter = new EntradaAdapter(getActivity(),listAnimation) ;
