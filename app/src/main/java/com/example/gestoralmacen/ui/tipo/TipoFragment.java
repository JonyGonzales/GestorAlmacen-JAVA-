package com.example.gestoralmacen.ui.tipo;
...
import com.example.gestoralmacen.AddTipoActivity;
import com.example.gestoralmacen.R;
import com.example.gestoralmacen.adapter.CategoriaAdapter;
import com.example.gestoralmacen.adapter.TipoAdapter;
...
public class TipoFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_add:
                Intent intent = new Intent(getActivity(), AddTipoActivity.class );
    ...
    private void setupRecyclerView(List<Tipo> listAnimation) {
        TipoAdapter myadapter = new TipoAdapter(getActivity(),listAnimation) ;
