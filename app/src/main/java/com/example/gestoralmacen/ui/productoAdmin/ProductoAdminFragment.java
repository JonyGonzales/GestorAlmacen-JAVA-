package com.example.gestoralmacen.ui.productoAdmin;
...
import com.example.gestoralmacen.adapter.ProductoAdminAdapter;
import com.example.gestoralmacen.model.Producto;
import org.json.JSONArray;
import java.util.ArrayList;
import java.util.List;

public class ProductoAdminFragment extends Fragment {
    ...
    private void CargarData() {
      ...
      private void setupRecyclerView(List<Producto> listAnimation) {
          ProductoAdminAdapter myadapter = new ProductoAdminAdapter(getActivity(),listAnimation) ;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_add:
                Intent intent = new Intent(getActivity(), AddProductoActivity.class );
