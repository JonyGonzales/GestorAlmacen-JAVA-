package com.example.gestoralmacen.ui.slideshow;
...
import com.example.gestoralmacen.adapter.SalidaAdapter;
...
public class SlideshowFragment extends Fragment {
    ...
    private void CargarData() {
      ...
      private void setupRecyclerView(List<Salida> listAnimation) {
          SalidaAdapter myadapter = new SalidaAdapter(getActivity(),listAnimation) ;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_add:
                Intent intent = new Intent(getActivity(), AddSalidaActivity.class );
                intent.putExtra("id","");
