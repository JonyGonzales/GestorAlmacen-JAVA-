 ...
 */
public class Salida {
    public static final String TABLE_NAME = "Salida";
    ...
    public Salida(int id, String cantidad, String fecha, String idProducto, String foto, String nombre, String idTipo, String tipo) {
        this.id = id;
